      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 p-8 mt-16 relative z-10 items-start">
        ...
        <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} className="space-y-12">
          <div className="space-y-6">
            ...
            {/* ИСПРАВЛЕННЫЙ ЗАГОЛОВОК: Больше не плывет, слова стоят друг под другом */}
          ...
          {/* КАРТОЧКИ С ЧИТАБЕЛЬНЫМИ ПОДСКАЗКАМИ */}
          <div className="grid grid-cols-2 gap-6">
            <div className="p-6 border border-white/5 rounded-2xl bg-white/[0.02] hover:bg-white/[0.05] transition-colors group relative cursor-help">
              ...
              {/* Tooltip 1: Увеличен шрифт и ширина */}
            ...
            <div className="p-6 border border-white/5 rounded-2xl bg-white/[0.02] hover:bg-white/[0.05] transition-colors group relative cursor-help">
              ...
              <p className="text-[10px] text-gray-500 uppercase font-bold">{txCount.toLocaleString()} Active Nodes</p>
               ...
               {/* Tooltip 2: Увеличен шрифт и ширина */}
            ...
            <div className="space-y-8">
              ...
              <div className="relative pt-2">
                <input 
                  ...
                  className="w-full bg-transparent text-6xl font-black focus:outline-none placeholder:text-white/5 !text-white tracking-tight"
                />
                ...
                <AnimatePresence mode="wait">
                  ...
                  {status === "encrypting" && (
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="space-y-2">
                      <p className="text-yellow-500/80 animate-pulse font-bold">{`> ENCRYPTING ${side.toUpperCase()} INTENT`}</p>
                      <p className="text-yellow-500/80 animate-pulse">{`> FRAGMENTING ${amount} SOL TO MXE NODES`}</p>
                      <p className="text-gray-600">{`> Verifying ZK-Proofs...`}</p>
                    </motion.div>
                  )}
                  {status === "success" && (
